...
4. Since the latest print issue doesn't have any text but rather a responsive image, I modified the data_point to the following: data_point = "" if target_element is None else target_element['href']
